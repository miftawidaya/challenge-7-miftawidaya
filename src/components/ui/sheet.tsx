      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            className={cn(
              'ring-offset-background focus:ring-ring bg-base-white absolute flex size-9 items-center justify-center rounded-full text-neutral-950 shadow-md transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none',
              side === 'left' && 'top-2 -right-12',
              side === 'right' && 'top-2 -left-12',
              side === 'top' && 'right-2 -bottom-12',
              side === 'bottom' && '-top-12 right-2'
            )}
          >
            <XClose className='size-5' strokeWidth={2.5} />
